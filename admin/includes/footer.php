<footer class="footer pt-5">
  ...
  <
  <script src="assets/js/core/jquery-3.7.0.min"></script>
  <script src="assets/js/core/bootstrap.bundle.min"></script>
  <script src="assets/js/plugins/perfect-scrollbar.min"></script>
  <script src="assets/js/plugins/smooth-scrollbar.min"></script>
